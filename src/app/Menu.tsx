...
export default function Menu() {
  const [isMenuOpened, setMenuOpened] = useState<null | boolean>(null);
        ...
        <div className="main-header-end u-margin-inline-end-16">
          <ul className="buttons-list is-with-padding">
            <li className="buttons-list-item">
              <a
                href="https://github.com/Meldiron/appwrite-ssr-next-js"
                target="_blank"
          ...
          <div className="side-nav-main">
            <section className="drop-section">
              <ul className="drop-list">
                ...
                <li className="drop-list-item">
                  <a className="drop-button u-cross-center is-selected" href="https://next-js.ssr.almostapps.eu/">
                    <svg
                      role="img"
                      width="16"
                      viewBox="0 0 24 24"
